...
from config.app.models import Flight, Passenger, Reservation
from config.app.serializers import FlightSerializer, PassengerSerializer, ReservationSerializer
